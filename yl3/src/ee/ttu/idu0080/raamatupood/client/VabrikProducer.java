 ...
 * @date 08.03.2010
 */
public class VabrikProducer {
	private static final Logger log = Logger.getLogger(VabrikProducer.class);
	public static final String SUBJECT = "UUSJRK"; // jÃ¤rjekorra nimi
	...
	public static void main(String[] args) {
		VabrikProducer producerTool = new VabrikProducer();
		producerTool.run();
	}
